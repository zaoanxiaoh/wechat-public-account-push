export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx2ea4e9a5d961840a",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "f4be24ea0177ac0abb26de38c152541d",
   ...
   */
  USERS: [f4be24ea0177ac0abb26de38c152541d
          f4be24ea0177ac0abb26de38c152541d
    {
      // 想要发送的人的名字
      name: "老婆0",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oU7lv54pvvETUcn4To8grrxcWrPs",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "GAhuV-VmVACoZc8TZN1SclXXIahm51nVTK1aVFCaGuE	",
      // 所在省份
      province: "福建",
      // 所在城市
      city: "三明",
